 ...
 */
public final class OpenCVOpeningOperator extends BaseMorphologicalOperator implements ErosionOperator {
   final static Logger logger = Logger.getLogger(OpenCVOpeningOperator.class.getName());
   ...
   public void execute() throws MorphologicalOperationException
   {
      ...
      try 
      {
         Imgproc.erode(input, intermediate, structuringElement);
         Imgproc.dilate(intermediate, destination, structuringElement);
      }
      catch (Exception ex)
      {
